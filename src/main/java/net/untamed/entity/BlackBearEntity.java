...
public class BlackBearEntity extends Animal implements NeutralMob {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new BlackBearEntity.BlackBearEntityAttackPlayersGoal());
    ...
    private class BlackBearEntityAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {

        public BlackBearEntityAttackPlayersGoal() {
            super(BlackBearEntity.this, Player.class, 20, true, true, null);
        }
        ...
        public boolean canUse() {
            ...
            if (super.canUse()) {
                for (BlackBearEntity blackBearEntity : BlackBearEntity.this.level().getEntitiesOfClass(BlackBearEntity.class, BlackBearEntity.this.getBoundingBox().inflate(8.0, 4.0, 8.0))) {
