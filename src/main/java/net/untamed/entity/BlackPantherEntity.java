...
public class BlackPantherEntity extends Animal implements NeutralMob {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return EntityInit.BLACK_PANTHER.create(serverLevel);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new BlackPantherEntity.BlackPantherEntityMeleeAttackGoal());
        ...
        this.targetSelector.addGoal(1, new BlackPantherEntity.BlackPantherEntityHurtByTargetGoal());
        this.targetSelector.addGoal(2, new BlackPantherEntity.BlackPantherEntityAttackPlayersGoal());
    ...
    private class BlackPantherEntityAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {

        public BlackPantherEntityAttackPlayersGoal() {
            super(BlackPantherEntity.this, Player.class, 20, true, true, null);
        }

        @Override
        public boolean canUse() {
            if (BlackPantherEntity.this.isBaby()) {
                return false;
            }

            if (super.canUse()) {
                for (BlackPantherEntity blackPantherEntity : BlackPantherEntity.this.level().getEntitiesOfClass(BlackPantherEntity.class, BlackPantherEntity.this.getBoundingBox().inflate(8.0, 4.0, 8.0))) {
                    if (blackPantherEntity.isBaby()) {
                        return true;
                    }
                }
            }
    ...
    private class BlackPantherEntityHurtByTargetGoal extends HurtByTargetGoal {

        public BlackPantherEntityHurtByTargetGoal() {
            super(BlackPantherEntity.this);
        }
        ...
        protected void alertOther(Mob mob, LivingEntity livingEntity) {
            if (mob instanceof BlackPantherEntity && !mob.isBaby()) {
                super.alertOther(mob, livingEntity);
            }
        }
    }

    private class BlackPantherEntityMeleeAttackGoal extends MeleeAttackGoal {

        public BlackPantherEntityMeleeAttackGoal() {
            super(BlackPantherEntity.this, 1.25, true);
        }
        ...
        protected void checkAndPerformAttack(LivingEntity livingEntity) {
            if (this.canPerformAttack(livingEntity)) {
                ...
                if (this.getTicksUntilNextAttack() <= 10) {
                    BlackPantherEntity.this.playWarningSound();
                }
            } else {
                this.resetAttackCooldown();
            }
