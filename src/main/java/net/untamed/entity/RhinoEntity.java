...
public class RhinoEntity extends Animal implements NeutralMob {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return EntityInit.RHINO.create(serverLevel);
    }
    ...
    public boolean canMate(Animal animal) {
        if (!(animal instanceof RhinoEntity rhinoEntity)) {
            return false;
        }
        return this.isInLove() && rhinoEntity.isInLove();
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new RhinoEntity.RhinoEntityMeleeAttackGoal());
        ...
        this.targetSelector.addGoal(1, new RhinoEntity.RhinoEntityHurtByTargetGoal());
        this.targetSelector.addGoal(2, new RhinoEntity.RhinoEntityAttackPlayersGoal());
    ...
    private class RhinoEntityAttackPlayersGoal extends NearestAttackableTargetGoal<Player> {

        public RhinoEntityAttackPlayersGoal() {
            super(RhinoEntity.this, Player.class, 20, true, true, null);
        }
        ...
        public boolean canUse() {
            ...
            if (super.canUse()) {
                for (RhinoEntity rhinoEntity : RhinoEntity.this.level().getEntitiesOfClass(RhinoEntity.class, RhinoEntity.this.getBoundingBox().inflate(8.0, 4.0, 8.0))) {
    ...
    private class RhinoEntityHurtByTargetGoal extends HurtByTargetGoal {

        public RhinoEntityHurtByTargetGoal() {
    ...
    private class RhinoEntityMeleeAttackGoal extends MeleeAttackGoal {

        public RhinoEntityMeleeAttackGoal() {
